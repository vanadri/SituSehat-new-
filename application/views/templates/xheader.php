...
<html lang="en">
  ...
  <body>
        ...
        <a class="navbar-brand" href="http://localhost/SituSehat/xhome" style="color: white;"><i class="fa fa-globe"></i>&nbsp;SituSehat</a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only"></span><span class="navbar-toggler-icon"></span></button>
                    ...
                    <li class="nav-item" role="presentation" style="border-radius: 50px;">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="http://localhost/SituSehat/xmPenyakit">Penyakit</a>
                                <a class="dropdown-item" href="http://localhost/SituSehat/xmGejala">Gejala</a>
                                <a class="dropdown-item" href="http://localhost/SituSehat/xmHidupSehat">Hidup Sehat</a>
                            </div>
                        </li>
                    </li>
